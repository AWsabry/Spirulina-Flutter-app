                  ...
                  child: Container(
                    ...
                    child: Column(
                      children: [
                        ...
                        Text('for Business inquires',style: TextStyle(fontSize:12),),
                        SizedBox(
                          height: 10,
                        ),
                        Text('spirulina.data@gmail.com',style: TextStyle(fontSize:12,fontWeight: FontWeight.bold),),
